...
- Встроенные прототипы могут быть изменены или дополнены новыми методами. Но не рекомендуется менять их. Единственная допустимая причина, это добавление нового метод из стандарта, который он ещё не поддерживается движком JavaScript.
